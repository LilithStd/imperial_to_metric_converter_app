...
//reset_component_content
export const HISTORY_RESET_VALUES = {
	EN: {
	...
	LV: {
		RESET_HISTORY: 'Atiestatīt vēsturi',
	},
};
export const FAVORITES_RESET_VALUES = {
	EN: {
		RESET_FAVORITES: 'Reset favorites',
	},
	RU: {
		RESET_FAVORITES: 'Сбросить избранное',
	},
	LV: {
